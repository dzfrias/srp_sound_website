...
fn App() -> Html {
    ...
    html! {
        <div class={classes!("m-auto", "2xl:w-3/4", "h-screen", "selection:bg-slate-400", "font-['Nunito']")}>
            ...
            <div class={classes!("md:w-1/2", "md:m-auto", "p-2", "rounded", "flex", "flex-col", "items-center", "border", "border-white", "shadow-md", "shadow-white", "bg-gradient-to-b", "from-blue-300", "to-green-200", "mx-4")}>
                <p class={classes!("text-center", "pb-16", "text-slate-800", "mt-5", "text-lg")}>{ "Listen to the audio samples! Make sure to write the 4 letter note sequence in the Google Form as well. To generate a new sound, either hit Enter or click the \"New Sound\" button." }</p>
