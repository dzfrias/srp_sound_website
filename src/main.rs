...
fn App() -> Html {
    ...
    html! {
        <div class={classes!("m-auto", "2xl:w-3/4", "h-screen", "selection:bg-slate-400")}>
            ...
            <div class={classes!("md:w-1/2", "m-auto", "p-2", "rounded", "flex", "flex-col", "items-center", "border", "border-white", "shadow-md", "shadow-white", "bg-gradient-to-b", "from-blue-300", "to-green-200")}>
                ...
                <audio controls=true src={format!("sounds/{}.wav", *audio_file)} format="audio/wav" class={classes!("bg-teal-600", "mb-5")}></audio>
            </div>
        </div>
    }
}
